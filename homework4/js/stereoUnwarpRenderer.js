...
var StereoUnwarpRenderer = function ( webglRenderer, dispParams ) {
	...
	//normalize correctly num/norm(den)
		var centerCoordL= new THREE.Vector2( -(0.5*dispParams.ipd)/(dispParams.canvasWidth), 0.5 );


		var centerCoordR = new THREE.Vector2( (0.5*dispParams.ipd)/(dispParams.canvasWidth), 0.5 );

		console.log("centerCoordL=",centerCoordL);
		console.log("centerCoordR=",centerCoordR);
